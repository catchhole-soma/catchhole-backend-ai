...
- 평가의 `extraction_max_output_tokens` 실험 옵션은 예측 step의 캐릭터 1차 상한에만 주입하며 기본 6,000과 대조 12,000을 지원한다. 절단 재시도 상한은 12,000을 유지하고 HTTP 읽기 제한·운영 설정·2차 및 judge 상한을 함께 변경하지 않는다.
