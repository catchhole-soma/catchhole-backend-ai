...
| 버전 | 기록일 | 변경 요약 | 품질 평가 |
| --- | --- | --- | --- |
| [v0004](v0004.md) | 2026-09-13 | main 기준 회차별 자동 확정·실패 격리 (#65 제외) | 품질 미측정 · 분리 검증은 버전 기록 참조 |
| [v0003](v0003.md) | 2026-09-11 | 신규 캐릭터 그룹 비교·근거 위치 기반 중복 제거 | 모델 평가는 미측정·결정론적 테스트 통과 |
| [v0002](v0002.md) | 2026-09-11 | OpenAI 응답 읽기 제한 120→300초 | Sol 503 실패; Terra 대조 완료·1차 F1 0.8511·2차 11/11(전체 Gold 15) |
| [v0001](v0001.md) | 2026-09-09 | 현재 main과 기존 FIXED 평가를 최초 등록 | 기존 실행 완료·새 기본 모델 조합 미측정 |

현재 main v0003은 #69의 신규 캐릭터 그룹 비교 기록이다. #70은 이를 포함한 v0004이며, 별도 #65의 세계관 추출·분류 변경은 포함하지 않는다.
