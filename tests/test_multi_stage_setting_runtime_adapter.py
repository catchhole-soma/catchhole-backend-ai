...
def test_fixed_runtime_reuses_character_dedupe_and_world_consolidation() -> None:
    ...
    assert bundle.prompt_versions["worldExtraction"] == "world-setting-extraction:v2"
    assert bundle.prompt_versions["worldComparison"] == "world-setting-comparison-batch:v9"
